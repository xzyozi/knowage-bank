...
| Rev.1.1 | 2026-08-15 | 開発チーム | 自由形式Markdownパース、Stage 0.5〜5 引用リナンバリングおよびアンカー自動連携仕様を追加 |
| Rev.1.2 | 2026-08-15 | 開発チーム | ドキュメント間整合性レビュー反映：KNB-DS-001およびKNB-DD-007への相互参照・注記を追加 |
